...
class TempDuckDB : TempDB {
	...
	init {
		...
		connection = DriverManager.getConnection("jdbc:duckdb:${tempDBPath.absolutePath}")
	}
	...
	override fun createTemp(file: File) {
		...
		connection = DriverManager.getConnection("jdbc:duckdb:${file.absolutePath}")
		tempDBPath = file
	}
